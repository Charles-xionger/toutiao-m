  ...
  methods: {
    ...
    async loadArticle () {
      ...
      try {
        ...
        // // 初始化图片预览
        // console.log(this.$refs['article-content']) // 打印为 undefined
    ...
    previewImage () {
      // 获取所有的 ImgDOM 节点
      const articleContet = this.$refs['article-content']
      const imgs = articleContet.querySelectorAll('img')
      // console.log(imgs)
      const images = []
